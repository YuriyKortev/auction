...
$("#addUser").submit(function () {
    ...
    $.post('/buyers',data,(id)=>{
        $("#list").append(`<div id="${id}"><img src="https://www.bsau.ru/upload/iblock/180/профиль%20мужской2.jpg"><p>${data.name}</p><p>${data.surname}</p><p name="money">${data.money}</p><p name="id">${'#'+id}</p></div>`);
        $("#addUser").find('input').each(function () {
